              ...
              {showUserMenu && (
                <div className="absolute top-full right-0 mt-4 w-48 bg-[#0D0B14] border border-[var(--color-border)] rounded-2xl shadow-xl overflow-hidden z-50 animate-fade-down">
                  ...
                  <div className="p-2 flex flex-col gap-1">
                    <Link to="/talent/account" onClick={() => setShowUserMenu(false)} className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-[var(--color-text-secondary)] hover:bg-[var(--color-surface-2)] hover:text-[var(--color-text-primary)] transition-colors w-full text-left">
                      <User size={16} /> Account
                    </Link>
                    <Link to="/talent/settings" onClick={() => setShowUserMenu(false)} className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-[var(--color-text-secondary)] hover:bg-[var(--color-surface-2)] hover:text-[var(--color-text-primary)] transition-colors w-full text-left">
